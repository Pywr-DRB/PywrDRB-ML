...
k_outer_loop = 5
k_inner_loop = 4
main_config_file = r"C:\Users\cl2769\Documents\GitHub\PywrDRB-ML\models\TempLSTM1.yml"
folder = "TempLSTM_CrossVali"
pn.models.mkdir(f"{folder}/cfg")
...
for outer_fold in crossval_folds:
    ...
    for inner_fold in outer_fold['inner_folds']:
        out_file = pn.models.get(folder) / f"cfg/model_config_outer_{outer_fold['outer_fold']}_inner_{inner_fold['inner_fold']}.yml"
