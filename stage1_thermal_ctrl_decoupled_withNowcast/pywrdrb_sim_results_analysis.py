...
salinity_dict = {
    "RBF-1": pd.read_csv(pn.outputs.get("stage1_nowcast_GaussianRBFPolicy_135322") / "df_pywrdrb_salinity_RBF1_159.csv", parse_dates=True, index_col=[0]),
    "RBF-2": pd.read_csv(pn.outputs.get("stage1_nowcast_GaussianRBFPolicy_135322") / "df_pywrdrb_salinity_RBF2_108.csv", parse_dates=True, index_col=[0]),
    "RBF-3": pd.read_csv(pn.outputs.get("stage1_nowcast_GaussianRBFPolicy_135322") / "df_pywrdrb_salinity_RBF3_106.csv", parse_dates=True, index_col=[0]),
    "RBF-4": pd.read_csv(pn.outputs.get("stage1_nowcast_GaussianRBFPolicy_135322") / "df_pywrdrb_salinity_RBF4_11.csv", parse_dates=True, index_col=[0]),
    "no_ctrl": pd.read_csv(pn.outputs.get("stage1_nowcast_GaussianRBFPolicy_135322") / "df_pywrdrb_salinity_no_ctrl.csv", parse_dates=True, index_col=[0]),
    "rule_based": pd.read_csv(pn.outputs.get("stage1_nowcast_GaussianRBFPolicy_135322") / "df_pywrdrb_salinity_rulebased.csv", parse_dates=True, index_col=[0]),
    }
