...
def eval_func(*params):
    ...
    def return_dps_func():#*params):
        ...
        def dps_func(model, Q_C, Q_i, cannonsville_storage_pct, current_date):
            ...
            df_t = df_t.loc[current_date.year:current_date.year, :]  # Get the data for the current year
            Jadd_t = compute_max_annual_accumulated_degree_days(df_t, col='T_L_mu', threshold=20, return_distribution=False)
