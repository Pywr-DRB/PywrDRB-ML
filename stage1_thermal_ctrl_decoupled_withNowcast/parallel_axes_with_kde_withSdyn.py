...
df_highlight["Jtubr"] = [0,        0.1739*3,  0.4994*3, 0.9993,  0.9993,  3.0,  3.0]
df_highlight["-Jrel"] = [-0.2018, -0.2136,   -0.4556,  -0.3427, -0.2213, -0.3719, -0.1981]
df_highlight["Jadd"] =  [1,        0.9727,     0.551,    0.9611,   0.9295,  0.9438, 0.8588]
df_highlight["label"] = ["no_ctrl", "rule_based", "historic\n(2010-2023)",
                         "RBF-1\n(Jtubr=1.0)", # 47
                         "RBF-2\n(Jtubr=1.0)", # 33
                         "RBF-3\n(Jrel=0.37)", # 49
...
cmap_highlights={
    ...
    'historic\n(2010-2023)': "blue",
    "RBF-1\n(Jtubr=1.0)": "lime",
    "RBF-2\n(Jtubr=1.0)": "aquamarine",
    "RBF-3\n(Jrel=0.37)": "saddlebrown",
    "RBF-4\n(Jadd=0.86)": "peru"
    }
ls_highlights={
    "RBF-3\n(Jrel=0.37)": "--",
...
for i, sol_idx in enumerate([47, 33, 49, 11]):
    ...
    df_rbf.to_csv(pn.outputs.get(f"dps_{policy}_{job_id}") / f"df_RBF{i+1}_{sol_idx}.csv")
