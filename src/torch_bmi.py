...
class bmi_lstm(Bmi):
    ...
    _input_var_names = [
        ...
        'doy',
        'rel_thermal',
        'tmmx_water_lordville_src_lag_1',
        'tmmx_water_cannonsville_src_lag_1',
        'tmmx_water_src_lag_1',
        'tmmn_water_lordville_src_lag_1',
        'tmmn_water_cannonsville_src_lag_1',
        'tmmn_water_src_lag_1',
        'tavg_water_lordville_src_lag_1',
        'tavg_water_cannonsville_src_lag_1',
        'tavg_water_src_lag_1',
        'QobsTmax_T_C_lag_1',
        'QobsTavg_T_C_lag_1',
        'QbcTmax_T_C_lag_1',
        'QbcTavg_T_C_lag_1',
        ...
        'QbcTmax_T_L_lag_1',
        'QbcTavg_T_L_lag_1',
        'QobsTavg_T_L_1_lag_1',
        'QbcTavg_T_L_1_lag_1',
        'QobsTmax_T_L_1_lag_1',
        'QbcTmax_T_L_1_lag_1',
        'QobsTmax_T_i_lag_1',
        'QobsTavg_T_i_lag_1',
        'QbcTmax_T_i_lag_1',
        'QbcTavg_T_i_lag_1',
        'QobsTavg_T_i_1_lag_1',
        'QbcTavg_T_i_1_lag_1',
        'y_src_lag_1',
        'saltfront_lag_1'
        ]
    ...
    _var_name_units_map = {
        ...
        '01463500_bc': ['01463500_bc', '--'],
        '01474500_bc': ['01474500_bc', '--'],
        'saltfront': ['saltfront', '--'],
        ...
        'QobsTavg_T_i_1': ['QobsTavg_T_i_1', '--'],
        'QbcTavg_T_i_1': ['QbcTavg_T_i_1', '--'],
        'QobsTavg_T_L_1': ['QobsTavg_T_L_1', '--'],
        'QbcTavg_T_L_1': ['QbcTavg_T_L_1', '--'],
        'QobsTmax_T_L_1': ['QobsTmax_T_L_1', '--'],
        'QbcTmax_T_L_1': ['QbcTmax_T_L_1', '--'],
        'doy_cos': ['doy_cos', '--'],
        'doy': ['doy', '--'],
        'rel_thermal': ['rel_thermal', 'mgd'],
        'tmmx_water_lordville_src_lag_1': ['tmmx_water_lordville_src_lag_1', '--'],
        'tmmx_water_cannonsville_src_lag_1': ['tmmx_water_cannonsville_src_lag_1',
        '--'],
        'tmmx_water_src_lag_1': ['tmmx_water_src_lag_1', '--'],
        'tmmn_water_lordville_src_lag_1': ['tmmn_water_lordville_src_lag_1', '--'],
        'tmmn_water_cannonsville_src_lag_1': ['tmmn_water_cannonsville_src_lag_1',
        '--'],
        'tmmn_water_src_lag_1': ['tmmn_water_src_lag_1', '--'],
        'tavg_water_lordville_src_lag_1': ['tavg_water_lordville_src_lag_1', '--'],
        'tavg_water_cannonsville_src_lag_1': ['tavg_water_cannonsville_src_lag_1',
        '--'],
        'tavg_water_src_lag_1': ['tavg_water_src_lag_1', '--'],
        ...
        'QobsTavg_T_L_1_lag_1': ['QobsTavg_T_L_1_lag_1', '--'],
        'QbcTavg_T_L_1_lag_1': ['QbcTavg_T_L_1_lag_1', '--'],
        'QobsTmax_T_L_1_lag_1': ['QobsTmax_T_L_1_lag_1', '--'],
        'QbcTmax_T_L_1_lag_1': ['QbcTmax_T_L_1_lag_1', '--'],
        ...
        'QobsTavg_T_i_1_lag_1': ['QobsTavg_T_i_1_lag_1', '--'],
        'QbcTavg_T_i_1_lag_1': ['QbcTavg_T_i_1_lag_1', '--'],
