...
lstm_settings_none = {
    "model_id": "TempLSTM1_none",
    "x_vars": ["tmmn", "tmmx", "pr", "srad", "bc_cannonsville_storage_pct", "doy"],
    "y_vars": ["QbcTavg_T_C"],
    "y_vars_src": ["tavg_water_cannonsville_src"],
    }

lstm_settings_lag1 = {
    "model_id": "TempLSTM1_lag1",
    "x_vars": ["tmmn", "tmmx", "pr", "srad", "bc_cannonsville_storage_pct", "doy", "QbcTavg_T_C"],
    "y_vars": ["QbcTavg_T_C"],
    "y_vars_src": ["tavg_water_cannonsville_src"],
    }

lstm_settings_Qc = {
    "model_id": "TempLSTM1_Qc",
...
lstm_settings_lag1_Qc = {
    "model_id": "TempLSTM1_lag1_Qc",
    "x_vars": ["tmmn", "tmmx", "pr", "srad", "bc_cannonsville_storage_pct", "doy", "QbcTavg_Q_C", "QbcTavg_T_C"],
    "y_vars": ["QbcTavg_T_C"],
    "y_vars_src": ["tavg_water_cannonsville_src"],
    }

#%%
subfolder = "TempLSTM1_comparison"
...
X = df[["tmmn", "tmmx", "pr", "srad", "bc_cannonsville_storage_pct", "doy"]].values
...
model_ids_none = ['TempLSTM1_none', 'TempLSTM1_Qc', 'rf_model']
model_ids_lag1 = ['TempLSTM1_lag1', 'TempLSTM1_lag1_Qc', 'rf_model']
...
#%% error_boxplot
for model_id in model_ids + ["rf_model"]:
    fig, ax = plt.subplots()
    sim, obs = pairs[model_id]
    sim, obs = clt.dropna_any(sim, obs)
