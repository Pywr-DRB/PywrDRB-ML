...
if policy_type == "piecewise":
    ...
    from stage1_thermal_ctrl_decoupled_.lstm_thermal_ctrl_gaussian_rbf import eval_func, n_dim, n_basis
    ...
    from stage1_thermal_ctrl_decoupled_.lstm_thermal_ctrl_regression import eval_func, n_dim, degree
    from src.policies import RegressionPolicy
    policy = RegressionPolicy(n_dim=n_dim, degree=degree)
elif policy_type == "cubic_rbf":
    from stage1_thermal_ctrl_decoupled_.lstm_thermal_ctrl_cubic_rbf import eval_func, n_dim, n_basis
...
from stage1_thermal_ctrl_decoupled_.borg import *
