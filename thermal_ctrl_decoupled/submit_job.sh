#!/bin/bash
#SBATCH --job-name=npub               # Job name
#SBATCH --output=/home/fs01/cl2769/Github/PywrDRB-ML/logs/dps_npub_%j.out   # Standard output log file with job ID
#SBATCH --error=/home/fs01/cl2769/Github/PywrDRB-ML/logs/dps_npub_%j.err    # Standard error log file with job ID
...
borg_seeds=(7 8 9 10 1 2 3 4 5 6)  # Add your borg seeds here
#6 7 8 9 10
...
submit_job() {
    ...
    time mpirun -np $n_processors python /home/fs01/cl2769/Github/PywrDRB-ML/thermal_ctrl_decoupled/borg_dps.py $SLURM_JOB_ID $policy_type $borg_seed
    #wait
