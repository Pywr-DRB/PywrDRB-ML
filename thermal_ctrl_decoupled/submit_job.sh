...
#SBATCH --output=/home/fs01/cl2769/Github/PywrDRB-ML/logs/dps_final_%j.out   # Standard output log file with job ID
#SBATCH --error=/home/fs01/cl2769/Github/PywrDRB-ML/logs/dps_final_%j.err    # Standard error log file with job ID
...
borg_seeds=(6 7 8 9 10 1 2 3 4 5)  # Add your borg seeds here
#6 7 8 9 10
