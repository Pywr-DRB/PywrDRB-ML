#!/bin/bash
#SBATCH --job-name=fpub               # Job name
#SBATCH --output=/home/fs01/cl2769/Github/PywrDRB-ML/logs/dps_fpub_%j.out   # Standard output log file with job ID
#SBATCH --error=/home/fs01/cl2769/Github/PywrDRB-ML/logs/dps_fpub_%j.err    # Standard error log file with job ID
